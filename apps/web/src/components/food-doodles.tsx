...
export function DoodleCarrot({ className }: DoodleProps) {
  return (
...
export function DoodleCitrusSlice({ className }: DoodleProps) {
  return (
...
export function DoodleBroccoli({ className }: DoodleProps) {
  return (
...
export function DoodleEgg({ className }: DoodleProps) {
  return (
    <svg viewBox="0 0 34 44" className={className} aria-hidden="true">
      <ellipse
        cx="17"
        cy="24"
        rx="14"
...
export function DoodlePepper({ className }: DoodleProps) {
  return (
...
export function DoodleGrapes({ className }: DoodleProps) {
  return (
...
export function DoodleMug({ className }: DoodleProps) {
  return (
...
export function DoodleLeafSprig({ className }: DoodleProps) {
  return (
...
export function DoodleCheeseWedge({ className }: DoodleProps) {
  return (
